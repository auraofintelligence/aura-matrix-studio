import {LIFE_PAGES} from './life-data.js?v=0.4.12';
import {framePoint} from './frame-display.js?v=0.4.12';
import {pageIcon} from './page-icons.js?v=0.4.12';
import {HOME,livePage,canonicalPage,CAMERA_VARIANTS,PAGE_ALIASES,PAGE_PARENTS} from './original-routes.js?v=0.4.12';

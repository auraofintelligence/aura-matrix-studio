import {validateTables,validateQuickStart} from './dataset-schema.js?v=0.4.5';
import {emptyFavourites,validateFavourites} from './favourites-data.js?v=0.4.5';
import {validateSpatial,validateTarget} from './spatial.js?v=0.4.5';

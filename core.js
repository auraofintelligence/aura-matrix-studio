import {validateShellStyles} from './shell-style.js?v=0.4.15';
import {validateTables,validateQuickStart} from './dataset-schema.js?v=0.4.15';
import {emptyFavourites,validateFavourites} from './favourites-data.js?v=0.4.15';
import {validateSpatial,validateTarget} from './spatial.js?v=0.4.17';
...
export function blankProject(){return {format:FORMAT,lattice:LATTICE,rows:ROWS,columns:COLS,records:[],links:[],story:makeStory(),selections:{},facetSelections:{},vectors:[],programs:[],stacks:[],tables:[],quickStart:{step:0},shellStyles:{},favourites:emptyFavourites()};}
...
export function validateProject(raw) {
  ...
  return {...blankProject(),records,links,story,...validateSpatial(raw,records),tables:validateTables(raw.tables),quickStart:validateQuickStart(raw.quickStart),shellStyles:validateShellStyles(raw.shellStyles),favourites:validateFavourites(raw.favourites)};
}

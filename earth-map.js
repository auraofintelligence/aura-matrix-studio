...
import {EARTH,EARTH_WIDE,earthRows,filterEarth,clusterEarth,pickEarthMarker,personalEarthRows,importEarthPoints,saveEarthPoints} from './earth-data.js?v=0.4.15';
import {readTravelProject,writeTravelProject,CELESTIAL} from './travel-data.js?v=0.4.15';

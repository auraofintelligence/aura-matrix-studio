...
import {PRESETS} from '../core.js?v=0.2.3';
import {target,targetPoint} from '../spatial.js?v=0.2.3';
...
test('actual Three scene draws all 100 layers and keeps markers and connections aligned after resizing the stack',async()=>{
  ...
  try{
    const {AuraView}=await import('../renderer.js?v=0.2.3'),view=Object.create(AuraView.prototype);

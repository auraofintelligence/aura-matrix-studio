import {AVATAR_QUESTIONS as AVATAR_FIELDS} from './avatar-data.js?v=0.4.5';
import {framePoint} from './frame-display.js?v=0.4.5';
import {tripForm,goalForm} from './travel-ui.js?v=0.4.5';
import {pageIcon} from './page-icons.js?v=0.4.5';
import {blankProject,validateProject,parseCSV,SHELLS} from './core.js?v=0.4.5';
import {allocationPlan,allocateTable,pendingRows} from './dataset-allocation.js?v=0.4.5';
import {targetLabel} from './spatial.js?v=0.4.5';
import {TORUS} from './original-routes.js?v=0.4.5';

import {mountPersonalSpace} from './personal-space-ui.js?v=0.4.9';
import {mountMeasurements} from './measurement-ui.js?v=0.4.9';
import {AVATAR_HOME,AVATAR_CREATION,AVATAR_SECTIONS,AVATAR_PAGES,avatarValues,avatarProgress,saveAvatar,avatarRatios} from './avatar-data.js?v=0.4.9';

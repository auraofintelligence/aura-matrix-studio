import {mountPersonalSpace} from './personal-space-ui.js?v=0.4.4';
import {AVATAR_HOME,AVATAR_SECTIONS,AVATAR_PAGES,avatarValues,avatarProgress,saveAvatar,avatarRatios} from './avatar-data.js?v=0.4.4';

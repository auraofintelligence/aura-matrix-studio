import {AVATAR_HOME,AVATAR_SECTIONS,AVATAR_PAGES,avatarValues,avatarProgress,saveAvatar,avatarRatios} from './avatar-data.js?v=0.4.0';
import {readTravelProject,writeTravelProject} from './travel-data.js?v=0.4.0';

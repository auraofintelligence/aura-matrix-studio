import {mountEarth} from './earth-map.js?v=0.3.7';
import {EARTH,EARTH_WIDE} from './earth-data.js?v=0.3.7';
import {mountTiming,mountTimingBadges} from './timing-ui.js?v=0.3.7';
import {TIMING_PAGES} from './timing-data.js?v=0.3.7';
import {mountTravel,mountTravelTimeline} from './travel-ui.js?v=0.3.7';
import {TRAVEL,TIMELINES,CELESTIAL} from './travel-data.js?v=0.3.7';
import {mountCelestial} from './celestial-clock.js?v=0.3.7';
import {mountMarket,MARKET_PAGES} from './market-map.js?v=0.3.7';
import {mountFavourites,FAVOURITES} from './original-favourites.js?v=0.3.7';
import {mountMenuCamera} from './menu-camera.js?v=0.3.7';
import {mountQuickStart,QUICKSTART} from './quickstart.js?v=0.3.7';
import {mountSiteMap,SITEMAP} from './original-sitemap.js?v=0.3.7';
import {livePage,parentPage,HOME,PROGRAMMER,canonicalPage,CAMERA_VARIANTS} from './original-routes.js?v=0.3.7';
import {mountLiveMatrix} from './original-live.js?v=0.3.7';
import {frameOrientation} from './frame-display.js?v=0.3.7';

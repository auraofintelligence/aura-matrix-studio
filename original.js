import {mountAffinity,AFFINITY_PAGES} from './affinity-ui.js?v=0.4.11';
import {mountPreferences,underPage,PREFERENCES} from './preferences-ui.js?v=0.4.11';
import {mountPalace,PALACE_PAGES} from './palace-ui.js?v=0.4.11';
import {mountSocial,isSocialPage,addSocialPages} from './social-ui.js?v=0.4.11';
import {AVATAR_HOME,AVATAR_CREATION,AVATAR_PAGES} from './avatar-data.js?v=0.4.11';
import {LIFE_PAGES,SOCIAL_HOME} from './life-data.js?v=0.4.11';
import {mountLife} from './life-ui.js?v=0.4.11';
import {mountAvatar} from './avatar-ui.js?v=0.4.11';
import {mountEarth} from './earth-map.js?v=0.4.11';
import {EARTH,EARTH_WIDE} from './earth-data.js?v=0.4.11';
import {mountTiming,mountTimingBadges} from './timing-ui.js?v=0.4.11';
import {TIMING_PAGES} from './timing-data.js?v=0.4.11';
import {mountTravel,mountTravelTimeline} from './travel-ui.js?v=0.4.11';
import {TRAVEL,TIMELINES,CELESTIAL} from './travel-data.js?v=0.4.11';
import {mountCelestial} from './celestial-clock.js?v=0.4.11';
import {mountMarket,MARKET_PAGES} from './market-map.js?v=0.4.11';
import {mountFavourites,FAVOURITES} from './original-favourites.js?v=0.4.11';
import {mountMenuCamera} from './menu-camera.js?v=0.4.11';
import {mountQuickStart,QUICKSTART} from './quickstart.js?v=0.4.11';
import {mountSiteMap,SITEMAP} from './original-sitemap.js?v=0.4.11';
import {livePage,parentPage,HOME,PROGRAMMER,canonicalPage,CAMERA_VARIANTS} from './original-routes.js?v=0.4.11';
import {mountLiveMatrix} from './original-live.js?v=0.4.11';
import {frameOrientation} from './frame-display.js?v=0.4.11';
